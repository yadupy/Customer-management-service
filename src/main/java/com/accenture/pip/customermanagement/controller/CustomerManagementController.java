...
public class CustomerManagementController {
    ...
    @ResponseBody
    public ResponseEntity<CustomerResponse> getCustomerByUserName(@PathVariable @Valid @NotNull String userName){
        log.info("GET Method called to fetch customer with userName {}",userName);
        CustomerResponse customerResponse  = customerManagementService.getCustomerByUserName(userName);
        return ResponseEntity.ok(customerResponse);
    }
