...
public class ContactNumberAlreadyInUseException  extends AbstractCustomerManagementException{
    ...
    public ContactNumberAlreadyInUseException(final Throwable cause){
        ...
        super(cause, HttpStatus.BAD_REQUEST, CustomerManagementConstant.CONTACT_NUMBER_ALREADY_IN_USE_EXCEPTION);
    }
    public ContactNumberAlreadyInUseException( ){

        super(null, HttpStatus.BAD_REQUEST, CustomerManagementConstant.CONTACT_NUMBER_ALREADY_IN_USE_EXCEPTION);
    }
}
